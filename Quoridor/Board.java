...
public class Board extends Actor
{
    ...
    public void initBattle()
    {
        ...
        battleList[1] = new RoboPlayer(Player.TOP, Player.MID, Player.BOT, "Red");
        battleList[2] = new PureRandom(Player.TOP, Player.MID, Player.BOT, "Red");
        battleList[3] = new SPRandom1(Player.TOP, Player.MID, Player.BOT, "Red");
